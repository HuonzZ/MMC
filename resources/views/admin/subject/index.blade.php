                            ...
                            <table class="table">
                                ...
                                @foreach($subject as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/subject/'.$item->id.'/edit') }}" title="Sửa thông tin bộ môn"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                            {!! Form::open([
                                                'method' => 'DELETE',
